...
public class OffCanvas extends UIPanel implements Styled {
    ...
    public static final String LEFT_TAB_BAR_SECTION = "left tab-bar-section";
    public static final String MIDDLE_TAB_BAR_SECTION = "middle tab-bar-section";
    public static final String RIGHT_TAB_BAR_SECTION_STYLE_CLASS = "right tab-bar-section";
